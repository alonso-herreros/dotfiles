...
local function shortcut_natural(keys, target)
	bind(keys, dsp.send_shortcut({mods="", key=target}), F("ulep"))
	bind("SHIFT+" .. keys, dsp.send_shortcut({mods="SHIFT", key=target}), F("ulep"))
	bind("CTRL+" .. keys, dsp.send_shortcut({mods="CTRL", key=target}), F("ulep"))
	bind("CTRL+SHIFT+" .. keys, dsp.send_shortcut({mods="CTRL+SHIFT", key=target}), F("ulep"))
end

-- ==== Un-numlock map ====
shortcut_natural("ALT + KP_0", "Insert")
shortcut_natural("ALT + KP_1", "End")
shortcut_natural("ALT + KP_2", "Down")
shortcut_natural("ALT + KP_3", "Page_Down")
shortcut_natural("ALT + KP_4", "Left")
shortcut_natural("ALT + KP_5", "Begin")
shortcut_natural("ALT + KP_6", "Right")
shortcut_natural("ALT + KP_7", "Home")
shortcut_natural("ALT + KP_8", "Up")
shortcut_natural("ALT + KP_9", "Page_Up")

shortcut_natural("MOD5 + KP_0", "Insert")
shortcut_natural("MOD5 + KP_1", "End")
shortcut_natural("MOD5 + KP_2", "Down")
shortcut_natural("MOD5 + KP_3", "Page_Down")
shortcut_natural("MOD5 + KP_4", "Left")
shortcut_natural("MOD5 + KP_5", "Begin")
shortcut_natural("MOD5 + KP_6", "Right")
shortcut_natural("MOD5 + KP_7", "Home")
shortcut_natural("MOD5 + KP_8", "Up")
shortcut_natural("MOD5 + KP_9", "Page_Up")
